...
public class main {
	...
	public static void main(String[] args) {
		Book b0 = new Book_Math("現代統計學","林惠玲、陳正倉","978-957-9096-80-5",2020,7,"statistics","Arithmetic");
		...
		Book b11 = new Book_Math("醫療資訊管理學","李友專、張顯洋、張慧朗、徐建業","978-986-194-503-3",2018,9,"Medical Information Management","none");
